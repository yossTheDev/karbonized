...
function MenubarTrigger({
	...
	return (
		<MenubarPrimitive.Trigger
			...
			className={cn(
				'flex items-center rounded-2xl px-3 py-0.75 text-sm font-medium outline-hidden select-none hover:bg-muted aria-expanded:bg-muted',
				className,
			)}
			{...props}
		/>
